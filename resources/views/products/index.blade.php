    ...
    <section class="relative mb-12 overflow-hidden">
        ...
        <div class="relative z-10 py-12 md:py-16">
            <div class="container-wide px-4 sm:px-6 lg:px-8 mx-auto">
                <div class="max-w-3xl">
                    <span
                        class="inline-flex items-center px-4 py-2 rounded-full text-xs font-medium bg-yellow-500/10 text-yellow-500 border border-yellow-500/30 mb-4 backdrop-blur-sm">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" x-cloak x-transition:enter="transition ease-out duration-200"
                    ...
                    <a href="#"
                        class="block px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-800/50 hover:text-yellow-500 transition-colors">Latest</a>
                    <a href="#"
                        class="block px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-800/50 hover:text-yellow-500 transition-colors">Price:
                        Low to High</a>
                    <a href="#"
                        class="block px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-800/50 hover:text-yellow-500 transition-colors">Price:
                        High to Low</a>
                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <a href="{{ route('products.show', $dress) }}" class="block">
                                <h3
                                    class="font-semibold text-white text-lg mb-2 line-clamp-1 hover:text-yellow-500 transition-colors">
                                    {{ $dress->name }}
                                </h3>
                            </a>
