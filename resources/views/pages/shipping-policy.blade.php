...
@section('content')
    ...
    <section class="container-wide px-4 sm:px-6 lg:px-8 mx-auto mb-20">
        <div class="bg-ink-raised/90 backdrop-blur-sm border border-line rounded-3xl p-8 md:p-12 space-y-10 text-bone-dim leading-relaxed">
            ...
            <div>
                <p>Every BUGGXIT Couture piece is made to order, so shipping works a little differently to off-the-shelf retail. Here's what to expect.</p>
            </div>
            ...
            <div>
                ...
                <p>For anything shipping-related, contact us via our <a href="{{ route('contact') }}" class="text-gold hover:text-gold-bright transition-colors">Contact page</a> and we'll be happy to help.</p>
            </div>
