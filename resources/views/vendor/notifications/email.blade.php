...
<body style="background-color: #0a0a0a; padding: 24px 16px;">
    <div class="email-container">
        <!-- Header -->
        <div class="header">
            <img src="{{ asset('Buggxit_Submark_Gold.svg') }}" alt="BUGGXIT Couture" class="logo"
        ...
        <div class="content">
            ...
            <div class="message">
                We received a request to reset the password for your admin account. Click the button below to create a
                new password. This link is valid for <strong>60 minutes</strong>.
            </div>
