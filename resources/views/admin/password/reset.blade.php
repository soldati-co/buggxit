...
@section('title', 'Create New Password - BUGGXIT Admin')

@section('header')
    <div class="flex flex-col items-center justify-center text-center">
        <h1 class="text-3xl md:text-4xl font-bold text-bone mb-2">
            <span class="text-gold">Create</span> New Password
        </h1>
        ...
        <div class="w-full max-w-md relative z-10">
            <div class="bg-ink-raised/90 backdrop-blur-sm border border-line rounded-xl shadow-lg overflow-hidden">
                <div
                    ...
                    <h2 class="text-2xl font-bold text-bone mb-2">Set New Password</h2>
                    <p class="text-sm text-bone-dim">Minimum 8 characters, strong passwords recommended</p>
                </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="password" required autofocus
                                class="w-full px-4 py-3 pl-12 bg-ink-raised2/50 border border-line rounded-lg text-bone focus:border-gold focus:ring-1 focus:ring-gold/30 pr-12">
