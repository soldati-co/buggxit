    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('admin.dresses.update', $dress) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <select name="sku_prefix" id="sku_prefix" required onchange="toggleCustomSku()"
                            ...
                            @foreach ($skuPrefixes as $code => $label)
                                <option value="{{ $code }}"
                                    {{ old('sku_prefix', $dress->sku_prefix) == $code ? 'selected' : '' }}
                                    class="bg-gray-900">
                                    {{ $label }}
                                </option>
                            @endforeach
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required
                            ...
                            <option value="draft" {{ old('status', $dress->status) == 'draft' ? 'selected' : '' }}
                                class="bg-gray-900">Draft</option>
                            <option value="active" {{ old('status', $dress->status) == 'active' ? 'selected' : '' }}
                                class="bg-gray-900">Active</option>
            ...
            <div class="bg-black/90 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
                ...
                <div class="mb-6">
                    <label for="main_image" class="block text-sm font-medium text-gray-400 mb-2">
                        {{ $dress->main_image_url ? 'Replace Main Image' : 'Upload Main Image' }} <span
                            class="text-yellow-500">{{ $dress->main_image_url ? '' : '*' }}</span>
                    </label>
                ...
                <!-- Gallery Images -->
                <div>
                    <label for="gallery_images" class="block text-sm font-medium text-gray-400 mb-2">Gallery
                        Images</label>
