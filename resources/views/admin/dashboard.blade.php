    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <a href="{{ route('admin.dresses.create') }}"
            ...
            <div class="p-3 bg-yellow-500/10 rounded-full group-hover:bg-yellow-500/20 transition-colors">
                <svg class="w-6 h-6 text-yellow-500 group-hover:scale-110 transition-transform" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path d="M12 4v16m8-8H4" />
                </svg>
            </div>
        ...
        <form action="{{ route('admin.dashboard.clear-cache') }}" method="POST" class="group">
            ...
            <button type="submit"
                ...
                <div class="p-3 bg-yellow-500/10 rounded-full group-hover:bg-yellow-500/20 transition-colors">
                    <svg class="w-6 h-6 text-yellow-500 group-hover:rotate-180 transition-transform duration-500"
                ...
                <div class="p-6">
                    @if ($recentDresses->count() > 0)
                        <div class="space-y-4">
                            @foreach ($recentDresses as $dress)
                                <div
                                    class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-800/30 transition-colors group">
                                    <div class="flex items-center space-x-4">
                                        <!-- Dress image -->
                                        <div
                                            class="w-12 h-12 rounded-lg bg-gray-800/50 border border-gray-700 overflow-hidden flex-shrink-0">
                                        ...
                                        <div>
                                            <a href="{{ route('admin.dresses.show', $dress) }}"
                                                class="font-medium text-white group-hover:text-yellow-500 transition-colors">
                                                {{ $dress->name }}
                                            </a>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <a href="{{ route('admin.dresses.create') }}"
                                class="mt-4 inline-flex items-center text-yellow-500 hover:text-yellow-400">
