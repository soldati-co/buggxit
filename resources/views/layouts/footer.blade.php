<footer class="relative bg-black/90 backdrop-blur-sm border-t border-gray-800 w-full overflow-hidden">
    ...
    <div
        class="absolute top-0 left-0 w-40 h-40 bg-yellow-500/5 rounded-full blur-3xl md:w-60 md:h-60 -translate-x-1/2 -translate-y-1/2">
    </div>
    <div
        class="absolute bottom-0 right-0 w-60 h-60 bg-yellow-500/3 rounded-full blur-3xl md:w-80 md:h-80 translate-x-1/2 translate-y-1/2">
    </div>
                ...
                <div class="space-y-6">
                    <div class="flex flex-wrap gap-3">
                        <a href="https://www.instagram.com/buggxit_couture/"
                            class="p-2.5 bg-gray-800/50 rounded-full text-gray-400 hover:text-yellow-500 hover:bg-gray-800/80 transition-all duration-300 group">
                    ...
                    <a href="{{ route('admin.login') }}"
                        class="inline-flex items-center px-4 py-2.5 text-sm border border-gray-700 rounded-full text-gray-400 hover:border-yellow-500 hover:text-yellow-500 hover:bg-yellow-500/10 transition-all duration-300 group">
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="{{ route('products.index') }}"
                            class="flex items-center text-gray-400 hover:text-yellow-500 text-sm transition-all duration-300 group">
                            <i
                                class="fas fa-chevron-right text-xs mr-2 opacity-0 group-hover:opacity-100 group-hover:text-yellow-500 transition-all duration-300"></i>
                            Products
                        </a>
                    </li>
