...
echo "Running safe migration checks (mark existing tables as migrated)..."
php scripts/mark_existing_migrations.php || echo "Migration helper script failed; continuing"
